    ...
    <div class="col-lg-8">
        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input value="{{ old('title', $post->title) }}" required autofocus type="text"
            ...
            <div class="form-group">
                ...
                <input value="{{ old('slug', $post->slug) }}" required type="text"
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="category" name="category_id">
                    @foreach ($categories as $category)
                        @if (old('category__id', $post->category_id) == $category->id)
