...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Post Categories</h1>
    </div>
    ...
    <div class="col-lg-8">
        ...
        <form action="/dashboard/categories/{{ $category->slug }}" method="POST" class="mb-5">
            ...
            <div class="form-group">
                ...
                <input value="{{ old('name', $category->name) }}" required autofocus type="text"
            ...
            <div class="form-group">
                ...
                <input value="{{ old('slug', $category->slug) }}" required type="text"
